...
namespace MrPlagueCustomRace.Common.Races.Examplians
{
	public class Examplian : Race
	{
		...
		public override void ModifyDrawLayers(Player player, List<PlayerLayer> layers)
		{
			...
			modPlayer.updatePlayerSprites(player, "MrPlagueRaces/Content/RaceTextures/", "MrPlagueCustomRace/Content/RaceTextures/Examplian/", hideChestplate, hideLeggings, 133, "Examplian", true);
